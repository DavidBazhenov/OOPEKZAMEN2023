...
```
&nbsp;&nbsp;&nbsp;&nbsp;*Метод должен иметь модификаторы **public static**, так как перегружаемый оператор будет использоваться для всех объектов данного класса.*

[еще инфа](https://metanit.com/sharp/tutorial/3.36.php)